      ...
      <div class="userListbox-nav">
        ...
        <div class="list_b">
          <el-table :data="goods" border stripe style="width: 100%">
            ...
            <!-- 角色 -->
            <el-table-column prop="roleDesc" label="商品价格" align="center"></el-table-column>
            <!-- 角色 -->
            <el-table-column prop="roleDesc" label="商品重量" align="center"></el-table-column>
            <!-- 角色 -->
            <el-table-column prop="roleDesc" label="创建时间" align="center"></el-table-column>
            <!-- 操作 -->
