  ...
  {{$store.state.user.tableData}}
    <div class="userListbox">
      ...
      <div class="userListbox-nav">
        <!-- 用户表格 -->
        <div class="list_b">
          <el-table :data="$store.state.user.tableData" border stripe style="width: 100%">
          <!-- 下标 -->
            ...
            <el-table-column label="状态" width="80">
              <template slot-scope="scope">
                <el-switch v-model="scope.mg_state"></el-switch>{{ scope.mg_state }}pp
              </template>
            </el-table-column>
            <!-- 操作 -->
