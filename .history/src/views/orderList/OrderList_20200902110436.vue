      ...
      <div class="userListbox-nav">
        ...
        <div class="list_b">
          <el-table :data="orders" border stripe style="width: 100%">
            ...
            <!-- 下标 -->
            <el-table-column prop="username" label="订单编号" width="200"></el-table-column>
            <!-- 姓名 -->
            <el-table-column prop="role_name" label="订单价格" width="330"></el-table-column>
            <!-- 角色 -->
            <el-table-column prop="email" label="是否付款" width="330"></el-table-column>
            <!-- 电话 -->
