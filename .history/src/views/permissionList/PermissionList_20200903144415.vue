  ...
  <div class="UserListbox">
    <div class="userListbox">
      <div class="userListbox-nav">
        <!-- 用户表格 -->
        <div class="list_b">
          <el-table :data="rightss" border stripe style="width: 100%">
            <!-- 下标 -->
            <el-table-column label="#" type="index" :index="indexMethod"></el-table-column>
            <!-- 姓名 -->
            <el-table-column prop="order_price" label="权限列表" width="180" align="center"></el-table-column>
            <!-- 角色 -->
            <el-table-column prop="pay_statuss" label="权限等级" width="180" align="center">
