              ...
              <template slot-scope>
                <div class="cloumnbox">
                  <div class="cloumnbox1">
                    <div class="cloumnbox2" v-for="item in arrlist[0].children" :key="item.id">
                      <!-- 一级权限 -->
                      <div class="cloumnbox2-item" v-if="item.children"><el-tag>{{item.authName}}</el-tag></div>
                      <!-- 二级权限 -->
