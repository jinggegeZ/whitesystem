          ...
          this.rightss.map((item,index) => {
            item.children.map((item1,index1) => {
              item1.children.map((item2,index2) => {
                console.log(arr.children[index].children[index1].children[index2]);
                if(arr.children[index].children[index1].children[index2]){
                  if(item2.authName===arr.children[index].children[index1].children[index2]){
