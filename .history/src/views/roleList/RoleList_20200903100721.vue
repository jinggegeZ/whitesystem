        ...
        <div class="list_b">
          <el-table :data="roles" border stripe style="width: 100%">
            ...
            <el-table-column type="expand">
              <template slot-scope="arrlist">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="一级权限">
                    <span>{{ arrlist.children.authName }}</span>
                  </el-form-item>
                  <el-form-item label="二级权限">
                    <span>{{ arrlist.children.children.authName}}</span>
                  </el-form-item>
                  <el-form-item label="三级权限">
                    <span>{{ arrlist.children.children.children.authName }}</span>
                  </el-form-item>
                </el-form>
                <!-- <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="商品名称">
                    <span>{{ arrlist.children.name }}</span>
                  </el-form-item>
                  <el-form-item label="所属店铺">
                    <span>{{ arrlist.children.shop }}</span>
                  </el-form-item>
                  <el-form-item label="商品 ID">
                    <span>{{ defaults.children.id }}</span>
                  </el-form-item>
                </el-form> -->
              </template>
            </el-table-column>
