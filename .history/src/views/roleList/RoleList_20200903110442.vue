                ...
                <div class="cloumnbox">
                  <div class="cloumnbox1">
                    <div class="cloumnbox2" v-for="item in arrlist" :key="item.id">
                      <!-- 一级权限 -->
                      <div class="cloumnbox2-item" v-if="item.children">{{item.roleName}}</div>
                      <!-- 二级权限 -->
                      <div v-if="item.children">
                        <div v-for="item1 in item.children" :key="item1.id">
                        <div class="cloumnbox2-item" v-if="item1.children">{{item1.roleName}}</div>
                      </div>
                      </div>
                      <!-- 三级权限 -->
                      <div v-if="item1.children">
                        <div v-for="item2 in item1.children" :key="item2.id">
                          <div class="cloumnbox2-item" v-if="item2.children">{{item2.roleName}}</div>
                        </div>
                      </div>
                    </div>
                  </div>
