                ...
                <div class="cloumnbox">
                  <div class="cloumnbox1">
                    <div class="cloumnbox2" v-for="item in props.row.children" :key="item.id">
                      <!-- 一级权限 -->
                      <div v-if="item.children"><el-tag>{{item.authName}}</el-tag></div>
                      <!-- 二级权限 -->
                      <div v-if="item.children">
                        <div v-for="item1 in item.children" :key="item1.id">
                        <div v-if="item1.children"><el-tag>{{item1.authName}}</el-tag></div>
                      </div>
                      </div>
                      <!-- 三级权限 -->
                      <div v-if="item1.children">
                        <div v-for="item2 in item1.children" :key="item2.id">
                          <div v-if="item2.children"><el-tag>{{item2.authName}}</el-tag></div>
                        </div>
                      </div>
                    </div>
                  </div>
