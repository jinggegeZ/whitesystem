                ...
                <div class="cloumnbox">
                  <div class="cloumnbox1">
                    <div class="cloumnbox2" v-for="item in arrlist" :key="item.id">
                      <div class="cloumnbox2-item" v-if="item.children">{{item.authName}}</div>
                      <div v-for="item1 in item.children" :key="item1.id">
                        <div class="cloumnbox2-item" v-if="item1.children">{{item1.authName}}</div>
                      </div>
                      <div v-for="item2 in item1.children" :key="item2.id">
                        <div class="cloumnbox2-item" v-if="item2.children">{{item2.authName}}</div>
                      </div>
                    </div>
                  </div>
                </div>
