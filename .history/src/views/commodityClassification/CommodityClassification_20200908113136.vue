  ...
  <div class="UserListbox">
    <div class="userListbox">
      ...
      <div class="userListbox-nav">
        <!-- 用户表格 -->
        <div class="list_b">
          <el-table :data="goodslist" border stripe style="width: 100%" row-key="cat_id" v-loading="!goodslist">
            <!-- 下标 -->
              ...
              >
                ...
                <el-form-item label="父类名称" prop="password">
                  <el-cascader
                    ...
                    clearable
                    @change="changelabel"
                    :disabled="formLabelAlign1.name === '' ? true : false"
                  >
          ...
          <el-dialog
            ...
            <span>
              <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign" :rules="ruless">
...
export default {
  ...
  methods: {
    ...
    changelabel(){
      ...
      if(this.prop.label.length === 1){
        this.cat_level = 1
         this.cat_pid=this.prop.label[0]
         console.log(this.cat_pid);
      }
      if(this.prop.label.length === 2){
         this.cat_level = 2
         this.cat_pid =this.prop.label[1]
         console.log(this.cat_pid);
      }
    },
    //添加用户
    addUser() {
      ...
      cat_name:this.formLabelAlign1.name,
