      ...
      <div class="contaner">
        ...
        <div class="rightbox">
          ...
          <div v-if="activeindex === 0">
            ...
            <div v-if="ruleForm.goodsname&&ruleForm.goodsprice&&ruleForm.goodsweight&&ruleForm.goodsnumber&&prop.label">
              <div><el-button type="success" @click="gonext(activeindex)">下一步</el-button></div>
            </div>
          </div>
          <div v-if="activeindex === 1">
            <div class="nextbox"><el-button type="success" @click="gonext(activeindex)">下一步</el-button></div>
          </div>
          <div v-if="activeindex === 2">
            
          <div class="nextbox">暂无属性<el-button type="success" @click="gonext(activeindex)">下一步</el-button></div>
          </div>
