              ...
              >
                <el-form-item label="商品名称" prop="goodsname">
                 ...
                 <el-form-item label="商品价格" prop="goodsprice">
                  <el-input v-model="ruleForm.goodsprice" :disabled="[ruleForm.goodsname === null ? 'true' : '']"></el-input>
                </el-form-item>
                 <el-form-item label="商品重量" prop="goodsweight">
                  <el-input v-model="ruleForm.goodsweight" :disabled="[ruleForm.goodsprice === null ? 'true' : '']"></el-input>
                </el-form-item>
                 <el-form-item label="商品数量" prop="goodsnumber">
                  <el-input v-model="ruleForm.goodsnumber" :disabled="[ruleForm.goodsweight === null ? 'true' : '']"></el-input>
                </el-form-item>
                 <el-form-item label="商品分类" prop="goodsclass">
                  <el-input v-model="ruleForm.goodsclass" :disabled="[ruleForm.goodsnumber === null ? 'true' : '']"></el-input>
