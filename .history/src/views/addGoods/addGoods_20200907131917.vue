            ...
            <div class="msgbox1">
              ...
              >
                <el-form-item label="商品名称" prop="goodsname">
                 ...
                 <el-form-item label="商品价格" prop="goodsprice"  :disabled="[ruleForm.goodsname === '' ? 'true' : '']">
                  <el-input v-model="ruleForm.goodsprice"></el-input>
                </el-form-item>
                 <el-form-item label="商品重量" prop="goodsweight" :disabled="[ruleForm.goodsprice === '' ? 'true' : '']">
                  <el-input v-model="ruleForm.goodsweight"></el-input>
                </el-form-item>
                 <el-form-item label="商品数量" prop="goodsnumber" :disabled="[ruleForm.goodsweight === '' ? 'true' : '']">
